...
public class singleTaskC2 extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn_goC1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(singleTaskC2.this, C1.class);
		...
		btn_goC2.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(singleTaskC2.this, singleTaskC2.class);
				startActivity(intent);
			}
		});
		...
		btn_goC3.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(singleTaskC2.this, C3.class);
				startActivity(intent);
			}
		});
	}
